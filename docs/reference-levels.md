...
- **Scoring audit 2026-04-28:** No new registry entries added today (all six signals are either below threshold, single-signal, license-blocked, or non-schema-mappable). Three-profile spot-check unchanged from 2026-04-27 — no regressions, no metadata fixes required.
...
- <img src="https://github.com/RooCodeInc.png" alt="Roo Code" width="18" /> [Roo Code](https://github.com/RooCodeInc/Roo-Code) — ⭐ 23,503 — VS Code extension with multi-persona role model ("a whole dev team of AI agents in your code editor"); architect, developer, reviewer roles in one IDE session; direct Level 1 competitor to Cline with distinct multi-role framing; Apache-2.0
...
- <img src="https://github.com/coreyhaines31.png" alt="marketingskills" width="18" /> [marketingskills](https://github.com/coreyhaines31/marketingskills) — ⭐ 23,796 🔥 marketing domain skill pack for Claude Code and AI agents; CRO, copywriting, ad copy, campaign analysis; largest-starred non-developer domain skill pack in this taxonomy; signals L4b expansion beyond software/knowledge-work into all professional verticals
...
- <img src="https://github.com/jamiepine.png" alt="Voicebox" width="18" /> [Voicebox](https://github.com/jamiepine/voicebox) — ⭐ 19,049 — open-source voice synthesis studio; TypeScript-first; voice cloning, style transfer, multi-speaker management; surpasses VoxCPM in star count; natural pairing for TypeScript/Vercel-ecosystem orgs; TypeScript-native voice output sub-type
- <img src="https://github.com/BasedHardware.png" alt="omi" width="18" /> [omi](https://github.com/BasedHardware/omi) — ⭐ 9,824 — passive ambient AI; continuously watches screen and listens to audio; proactively surfaces suggestions without push-to-activate; Flutter/Dart, cross-platform; "advisor in the room" model for exec/PM personas; new passive-ambient sub-type distinct from hold-to-talk (Ghost Pepper) and dictation (Superwhisper)
- <img src="https://github.com/thunderbird.png" alt="Thunderbolt" width="18" /> [Thunderbolt](https://github.com/thunderbird/thunderbolt) — ⭐ 2,205 — privacy-first cross-platform AI client (web/iOS/Android/macOS/Linux/Windows); MPL 2.0; compatible with Ollama/llama.cpp/OpenAI-compatible APIs; "choose your models, own your data"; enterprise on-premises deployment; from Thunderbird/Mozilla ecosystem; first on-premises AI client sub-type in Level 7
