...
- **Scoring audit 2026-05-04:** Five research-watch signals assessed. **Two map mutations applied:** (i) n8n-mcp added to L4c (19.5k★, workflow-platform MCP bridge); (ii) CocoIndex added to L6 (7.7k★, incremental ingestion pipeline). Three entries held: Ruflo (explicit defer in research-watch doc), ouroboros (already in map), browserbase/skills (below threshold).
